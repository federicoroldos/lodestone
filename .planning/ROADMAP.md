...
> Single source of truth for what we're building. Updated as phases are added
> or completed. See `.planning/STATE.md` for current status.

## Milestone: Friendlier Panel for Non-Tech Operators

Make Lodestone approachable for users who can run a Minecraft server but
